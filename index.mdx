---
title: "Introduction"
description: "Welcome to Cuey - Precision webhook scheduling"
---
...
<CardGroup cols={2}>
  ...
  <Card title="Installation" icon="download" href="/installation">
    Install the TypeScript client and start building.
  </Card>
  <Card
    title="Retrying Events"
    icon="exclamation-triangle"
    href="/retrying-events"
  >
  ...
  >
    Learn about the type-safe SDK with comprehensive examples.
  </Card>
